<template>
  <div class="container flex-auto mx-auto mt-5 px-4 sm:px-6 xl:px-8 pt-10 pb-16">
    <section v-show="!checkAuth"
             class="relative flex flex-col items-center w-full px-4 py-8 mx-auto text-center rounded-lg shadow-2xl lg:text-left lg:block bg-gradient-to-br from-purple-600 via-indigo-500 to-teal-400 sm:px-6 md:pb-0 md:pt-12 lg:px-12 lg:py-12">
      <h2
    ...
    <section
      ...
      <input @keypress.enter="addTodo" class="flex-auto w-full rounded-lg outline-none py-3 px-4" placeholder="Your todo..."
             type="text" v-model="text"
             autofocus/>
      <button
        class="flex-none bg-white hover:bg-gray-200 focus:outline-none transition-colors duration-200 text-gray-900 font-semibold rounded-lg py-3 px-4"
